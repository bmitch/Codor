...
/** @group Files */
class NotReturnNullIfComparisonWithNullSniffTest extends BaseTestCase
{
    ...
    /** @test */
    public function it_detects_functions_that_return_not_null_if_comparison_with_null()
    {
        $results = $this->runner->sniff('FunctionNotReturnNullIfComparisonWithNull.inc');
